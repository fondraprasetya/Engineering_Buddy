        ...
        <AuthenticatedLayout auth={auth}>
            ...
            <div className="max-w-lg mx-auto">
                ...
                <form onSubmit={submit} className="bg-white rounded-2xl shadow-sm p-6 space-y-4">
                    ...
                    {data.type === 'waste' ? (
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div>
                                ...
                                <input type="number" step="0.01" min="0" value={data.beginning_stand} readOnly className="w-full rounded-xl border border-gray-200 bg-gray-100 px-3 py-2 text-sm text-gray-600" placeholder={t('ut.auto_prev_ph')} />
                            </div>
                            <div>
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">{t('ut.photo')} <span className="text-red-500">*</span></label>
                    ...
                    <button type="submit" disabled={processing} className="w-full bg-brand-400 text-white rounded-xl py-2.5 text-sm font-medium hover:bg-brand-600 disabled:opacity-50">
                        {processing ? t('ut.saving') : t('ut.save_record')}
                    </button>
                </form>
            </div>
        </AuthenticatedLayout>
