            ...
            <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex flex-col items-center justify-center px-4 py-12">
                ...
                >
                    <div className="text-center mb-8">
                        ...
                        <p className="text-sm text-gray-500 mt-1">{t('auth.signin_sub')}</p>
                    </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-lg shadow-blue-100/50 p-7">
                        <form onSubmit={submit} className="space-y-5">
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <a href="#" className="text-sm text-brand-600 hover:text-brand-700 font-medium">{t('auth.forgot')}</a>
                            </div>
                            ...
                            >
                                {processing ? t('auth.signing_in') : t('auth.signin_btn')}
                            </button>
                        </form>
                    </div>

                    <div className="flex items-center justify-center gap-3 mt-8">
                        <p className="text-xs text-gray-400">Engineering Buddy &copy; {new Date().getFullYear()}</p>
                        <LangToggle />
                    </div>
                </motion.div>
            </div>
